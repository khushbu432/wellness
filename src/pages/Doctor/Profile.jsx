    ...
    useEffect(() => {
        fetch("https://logink123.herokuapp.com/user/loggedin", {
            ...
            .then((report) => {
                ...
                setOt(new Date(report.account[0]["opentime"]).toISOString().split('T')[1]) 
                setCt(new Date(report.account[0]["closetime"]).toISOString().split('T')[1]) 
                            ...
                            <div className="col-span-2">
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="mt-4 text-3xl text-left block card-actions">
                                        ...
                                        <h1>Fees : {fees}</h1> <hr />
                                        <h1>Open-Time : {ot}</h1> <hr />
                                        <h1>Close-Time : {ct}</h1> <hr />
