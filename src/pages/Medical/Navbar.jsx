    ...
    <div class="navbar bg-neutral text-neutral-content">
        <div class="flex-none">
          ...
          <div class="dropdown">
            ...
            <li><Link to="/Medical/Medhome"><FaHome />Dashboard</Link></li>
              <li><Link to='/Medical/Medhistory'><FaHistory />History</Link></li>
               <li><Link to='/Medical/Medinventory'><FaDatabase />Inventory</Link></li>
              <li><Link to='/Medical/MedAddNew'><FaPlus />Add New Order</Link></li> 
