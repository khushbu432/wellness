...
function Navbar({image,url,profileurl}) {
  ...
  <ul tabindex="0" class="dropdown-content font-bold text-blue-600 menu p-2 shadow bg-base-100 rounded-box w-52">
    <li><Link to='/PatientHome/Profile'>Profile</Link></li>
    <li><Link to='/PatientHome/corder'>Orders</Link></li>
    <li><Link to='/PatientHome/Cart'>Cart</Link></li>
    <li>Prescriptions</li>
    ...
    <div class="dropdown dropdown-end">
      ...
      <div tabindex="0" class="mt-3 font-bold text-blue-600 card card-compact dropdown-content w-52 bg-base-100 shadow">
        <div class="card-body">
          ...
          <span class="text-info text-blue-700"></span>
