    ...
    useEffect(() => {
        fetch("https://logink123.herokuapp.com/user/loggedin", {
            ...
            .then((report) => {
                ...
                setCity(report.account[0]["address"].city);
                setState(report.account[0]["address"].state);
                setDob(report.account[0]["dob"])
                console.log(report.account[0]["dob"])
