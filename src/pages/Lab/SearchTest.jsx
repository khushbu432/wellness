...
useEffect(() =>{
  fetch(`https://logink123.herokuapp.com/test/find?${option}=${input}`, requestOptions)
...
onMouseEnter={(e) => ReactSession.set("deleteTest",curElem._id)} onClick={deletetest}>Delete</button> </a> </td>
                            </tr>
